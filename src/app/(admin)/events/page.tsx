    ...
    <PageShell>
      ...
      <div className="card">
        {canWriteEvents ? (
          ...
          <div className="sm:col-span-2">
            <label htmlFor="ev-description" className="label">{EVENTS_ADMIN_LABELS.formDescription}</label>
            <textarea id="ev-description" name="description" required rows={2} className="input" />
          </div>
          <div>
            <label htmlFor="ev-unit" className="label">{EVENTS_ADMIN_LABELS.formUnit}</label>
          ...
          <div>
            <label htmlFor="ev-category" className="label">{EVENTS_ADMIN_LABELS.formCategory}</label>
            <select id="ev-category" name="category" className="input" defaultValue="HOUSE_MEETING">
          ...
          <div>
            <label htmlFor="ev-location" className="label">{EVENTS_ADMIN_LABELS.formLocation}</label>
            <input id="ev-location" name="location" className="input" />
          </div>
          <div>
            <label htmlFor="ev-startsAt" className="label">{EVENTS_ADMIN_LABELS.formStartsAt}</label>
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                  <div className="min-w-0">
                    ...
                    <div className="mt-2 flex flex-wrap gap-3 text-xs text-ui-muted">
                      <span>{EVENTS_ADMIN_LABELS.unit}: {event.housingUnitCode}</span>
