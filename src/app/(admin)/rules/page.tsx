...
const DELEGATION_EXPLANATIONS: Record<string, string> = {
  ...
  UNIT_MAY_STRENGTHEN: `Die ${BRAND.orgName}-Regel ist das Minimum. Ein Haus kann strenger werden — die Betreuung bestätigt, dass der Beschluss die ${BRAND.orgName}-Regel nicht unterläuft.`,
  UNIT_DECIDES: `Die ${BRAND.orgName} gibt nur das Thema vor. Wie es im Haus gilt, beschliessen die Bewohnenden selbst.`,
}
