...
export function DataCollectionTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="card">
        <h3 className="font-semibold text-gray-900 mb-4">{DATA_COLLECTION_TAB_LABELS.formSectionsTitle}</h3>
            ...
            return (
              <div key={section.id} className="bg-gray-50 rounded-lg p-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-gray-500">{factorCount} {DATA_COLLECTION_TAB_LABELS.fieldsSuffix}</span>
                </div>
                {section.description && (
