      ...
      {options.map((option) => {
        ...
        return (
          <label key={option.value} className="cursor-pointer">
            ...
            />
            <div className="px-4 py-2.5 rounded-full border-2 border-ui-border peer-checked:border-brand-primary peer-checked:bg-brand-primary peer-checked:text-ui-on-accent transition-colors text-sm min-h-[44px] flex items-center">
              {option.label}
            </div>
          </label>
        )
