...
export const PORTAL_LABELS = {
  ...
  preferences: {
    ...
    successMessage: 'Deine Präferenzen wurden gespeichert. Das AOZ-Team prüft deine Änderungen.',
    ...
    // Word labels for the 1-5 rating scales (index 0 = value 1)
    scale: {
      selectedOf: 'von 5',
      noiseTolerance: {
        lowEmoji: '🤫',
        highEmoji: '🔊',
        values: ['Sehr empfindlich', 'Eher empfindlich', 'Mittel', 'Eher tolerant', 'Sehr tolerant'],
      },
      cleanlinessLevel: {
        lowEmoji: '🙂',
        highEmoji: '✨',
        values: ['Entspannt', 'Eher entspannt', 'Mittel', 'Ordentlich', 'Sehr ordentlich'],
      },
      privacyNeed: {
        lowEmoji: '👥',
        highEmoji: '🚪',
        values: ['Sehr offen', 'Eher offen', 'Mittel', 'Eher zurückgezogen', 'Viel Privatsphäre'],
      },
    },
  },
  satisfaction: {
  ...
  transfer: {
    ...
    statusCard: {
      title: 'Deine Verlegungsanfrage',
      details: 'Details',
      requestedOn: 'Angefragt am',
      targetUnit: 'Wunsch-Unterkunft',
      pending: 'In Prüfung',
      approved: 'Bewilligt',
      pendingInfo: 'Das Team prüft deine Anfrage. Du wirst benachrichtigt, sobald es Neuigkeiten gibt.',
      approvedInfo: 'Deine Anfrage wurde bewilligt. Das Team meldet sich bei dir wegen der nächsten Schritte.',
    },
  },
  help: {
    ...
    emergencyDesc: 'Bei Notfällen oder akuter Gefahr rufe sofort 112 an oder wende dich an:',
    emergency: {
      numbers: [
        { icon: '🚨', label: 'Allgemeiner Notruf', number: '112', note: 'Funktioniert in der ganzen Schweiz' },
        { icon: '👮', label: 'Polizei', number: '117' },
        { icon: '🚑', label: 'Rettungsdienst', number: '144' },
        { icon: '🆘', label: 'AOZ Notfallnummer', number: '044 415 66 00', note: '24h erreichbar' },
      ],
    },
    contacts: [
      { icon: '📞', label: 'Allgemeine Anfragen (kein Notfall)', value: '044 415 66 66', sublabel: 'Mo-Fr 8:00-17:00' },
  ...
  error: {
    ...
    message: 'Beim Laden der Portalseite ist ein Fehler aufgetreten. Bitte versuche es erneut.',
