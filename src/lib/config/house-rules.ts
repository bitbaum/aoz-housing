...
export const RULE_DELEGATION_DESCRIPTIONS: Record<RuleDelegation, string> = {
  ...
  UNIT_MAY_STRENGTHEN: `Die ${BRAND.orgName}-Regel ist das Minimum. Das Haus kann strengere Regeln beschliessen, nie lockerere.`,
  UNIT_DECIDES: `Die ${BRAND.orgName} gibt nur das Thema vor. Wie es im Haus konkret gilt, beschliessen die Bewohnenden.`,
}
...
export const ORG_RULE_CATALOG: readonly OrgRuleSeed[] = [
  {
    ...
    body: `Körperliche Gewalt, Drohungen, Einschüchterung und sexuelle Belästigung sind in allen ${BRAND.orgName}-Unterkünften verboten. Bei akuter Gefahr: sofort die Betreuung oder die Polizei (117) rufen.`,
    delegation: 'FIXED',
  },
  {
    key: 'respect_dignity',
    ...
    body: 'Alle im Haus werden mit Respekt behandelt — unabhängig von Herkunft, Sprache, Religion, Geschlecht, sexueller Orientierung, Alter oder Gesundheit. Beleidigungen und Ausgrenzung sind nicht erlaubt.',
    delegation: 'FIXED',
  },
  {
    key: 'privacy_rooms',
    ...
    body: 'Zimmer und persönliche Sachen anderer nur mit deren Einverständnis betreten oder benutzen. Das gilt auch im geteilten Zimmer.',
    delegation: 'FIXED',
  },
  {
    ...
    body: 'Wer sich gestört fühlt, spricht es zuerst ruhig und direkt an — je früher, desto einfacher. Kommt ihr nicht weiter, hilft die Betreuung bei der Vermittlung. Niemand muss einen Konflikt allein lösen, und niemand hat Nachteile, weil er oder sie Hilfe holt.',
    delegation: 'FIXED',
  },
  {
    key: 'fire_safety',
  ...
  },
  {
    ...
    body: 'In Zimmern, Küchen, Bädern, Fluren und allen anderen Innenräumen wird nicht geraucht — auch nicht am Fenster. Das gilt auch für E-Zigaretten.',
    delegation: 'FIXED',
  },
  {
    key: 'smoking_areas',
    ...
    body: 'Wo genau draussen geraucht wird und wie die Aschenbecher geleert werden, legt das Haus selbst fest.',
  ...
  },
  {
    ...
    body: 'Herstellung, Handel und Konsum illegaler Substanzen sind in der Unterkunft verboten. Wer Unterstützung bei einer Sucht möchte, kann sich vertraulich an die Betreuung wenden.',
    delegation: 'FIXED',
  },
  {
    key: 'weapons',
    category: 'SAFETY',
    title: 'Keine Waffen',
    body: 'Waffen und waffenähnliche Gegenstände dürfen nicht in die Unterkunft gebracht werden.',
    delegation: 'FIXED',
  },
  {
    ...
    body: 'Defekte, Wasserschäden, Ungeziefer und kaputte Geräte werden sofort gemeldet — über die App oder bei der Betreuung. Wer einen Schaden meldet, wird nicht dafür bestraft; wer einen Schaden verschweigt, haftet für Folgeschäden. Kleine Reparaturen wie der Austausch von Leuchtmitteln oder die einfache Reinigung von Abflüssen werden selbstständig ausgeführt. Grössere Reparaturen führt ausschliesslich die Immobilienverwaltung oder eine beauftragte Firma aus.',
    delegation: 'FIXED',
  },
  {
    ...
    body: `Die Einrichtung und sämtliche Gegenstände werden mit Sorgfalt benutzt; absichtliche oder durch unsachgemässen Gebrauch verursachte Schäden werden verrechnet. Bauliche Veränderungen sind nicht erlaubt — keine Wanddurchbrüche, keine neuen Wände. Ausserhalb der Wohnung (Hauseingang, Treppenhaus, Keller) dürfen keine Gegenstände platziert werden. Der Aussenbereich wird ausschliesslich gemäss den Anweisungen der ${BRAND.orgName} benutzt.`,
    delegation: 'FIXED',
  },
  {
  ...
  },
  {
    ...
    body: 'Die Bewohnenden halten die Unterkunft sauber und in Ordnung. Die Zimmer werden täglich gelüftet — das verhindert Schimmel und schlechte Luft.',
    delegation: 'FIXED',
  },
  {
    key: 'shared_cleaning',
  ...
  },
  {
    ...
    body: 'Hausabfall gehört in die dafür bestimmten Abfallsäcke (blaue «Züri-Säcke») und danach in die vorgesehenen Container. Plastik, Glas, Metall, Öl, Elektrogeräte und Sperrgut werden selbstständig an den offiziellen Sammelstellen von ERZ (Entsorgung + Recycling Zürich) entsorgt.',
    delegation: 'FIXED',
  },
  {
    ...
    body: 'Kochherd und Backofen dürfen nur bei Anwesenheit benutzt werden — unbeaufsichtigte Speisen sind Brandgefahr. Nach Gebrauch werden die Kochgeräte ausgeschaltet.',
    delegation: 'FIXED',
  },
  {
    key: 'kitchen_use',
    category: 'KITCHEN',
    title: 'Küche',
    body: 'Nach dem Kochen wird aufgeräumt und abgewaschen. Alles Weitere — Kochzeiten, Kühlschrankfächer, gemeinsame Vorräte, Umgang mit stehengelassenem Geschirr — beschliesst das Haus.',
    delegation: 'UNIT_DECIDES',
  },
  {
    key: 'bathroom_use',
    category: 'BATHROOM',
    title: 'Bad und WC',
    body: 'Das Bad wird sauber hinterlassen. Duschzeiten am Morgen, Reinigungsturnus und Ablage von persönlichen Sachen beschliesst das Haus.',
    delegation: 'UNIT_DECIDES',
  },
  {
    ...
    body: 'Wie die Aufenthaltsräume genutzt werden — Fernsehzeiten, Kinderbereich, Waschmaschinen-Turnus — beschliesst das Haus.',
    delegation: 'UNIT_DECIDES',
  },
  {
    key: 'energy_costs',
    ...
    body: 'Licht, Heizung und Wasser werden sparsam genutzt; Fenster beim Heizen nicht dauerhaft offen lassen. Das Haus kann konkretere Abmachungen treffen.',
    delegation: 'UNIT_MAY_STRENGTHEN',
  },
] as const
