...
export const HOUSING_FACTORS: Record<string, HousingFactorDef> = {
  ...
  privateRooms: {
    ...
    type: 'scale',
    label: 'Einzelzimmer',
    description: 'Für Bewohner die Einzelzimmer benötigen',
    formSection: 'capacity',
    formOrder: 4,
    min: 0,
    max: 10,
  ...
  privateBathrooms: {
    ...
    type: 'scale',
    label: 'Private Bäder',
    description: 'Für Bewohner die geteiltes Bad nicht können',
    formSection: 'facilities',
    formOrder: 2,
    min: 0,
    max: 5,
  ...
  privateKitchen: {
    ...
    type: 'boolean',
    label: 'Private Küche',
    description: 'Für Bewohner mit speziellen Ernährungsbedürfnissen',
    formSection: 'facilities',
    formOrder: 4,
    default: false,
    trueLabel: 'Vorhanden',
  ...
  groundFloor: {
    ...
    type: 'boolean',
    label: 'Erdgeschoss',
    description: 'Für Bewohner die keine Treppen steigen können',
  ...
  nearHealthServices: {
    ...
    description: 'Wichtig für Bewohner mit Unterstützungsbedarf',
    formSection: 'location',
    formOrder: 2,
    default: false,
    category: 'location',
