...
export const tr: Dictionary = {
  ...
  'dashboard.welcomeSubtitle': 'Evinle ilgili her şey burada',
  'dashboard.yourHousing': 'Evin',
  'dashboard.active': 'Aktif',
  'dashboard.moveIn': 'Taşınma',
  'dashboard.rooms': 'Odalar',
  'dashboard.roommates': 'Ev arkadaşları',
  'dashboard.compatibility': 'Uyum',
  ...
  'dashboard.petsAllowed': 'Evcil hayvana izin var',
  'dashboard.noPets': 'Evcil hayvan yok',
  'dashboard.showAll': 'Tümünü göster',
  'dashboard.noReports': 'Bildirim yok',
  'dashboard.openMaintenance': 'Binada açık bakım talepleri',
  'dashboard.reported': 'Bildirildi',
  'dashboard.onboarding.title': 'Profilin oluşturuldu',
  'dashboard.onboarding.subtitle': 'Senin için uygun evi arıyoruz',
  'dashboard.onboarding.step1': 'Profil oluşturuldu',
  'dashboard.onboarding.step2': 'Tercihlerini tamamla',
  'dashboard.onboarding.step3': 'Ev ara',
  'dashboard.onboarding.step4': 'Taşınma',
  'dashboard.onboarding.completePreferencesHint': 'Seni ne kadar çok tanırsak, sana o kadar uygun ev arkadaşları bulabiliriz.',
  'dashboard.onboarding.browseHousing': 'Mevcut evlere göz at',
  'dashboard.onboarding.browseHousingHint': 'Tercihlerine uyan evlere göz at.',
  'quickActions.chores': 'Görevler',
  'quickActions.report': 'Sorun bildir',
  'quickActions.learning': 'Öğrenme',
  'quickActions.preferences': 'Tercihler',
  'prioritySections.now': 'Şimdi',
  'prioritySections.taskSingular': 'görev ilgi bekliyor.',
  'prioritySections.taskPlural': 'görev ilgi bekliyor.',
  'prioritySections.nextDesc': 'Sorunları erkenden bildir ve tercihlerini güncel tut.',
  'pendingChores.title': 'Açık görevler',
  'pendingChores.requestOpen': 'Talep açık',
  'pendingChores.needsAttention': 'İlgi bekliyor',
  'reports.inProgress': 'işlemde',
  'care.unassigned': 'Atanmadı',
  'socialStyle.INTROVERTED': 'Sakin',
  'socialStyle.MODERATE': 'Dengeli',
  'socialStyle.EXTROVERTED': 'Sosyal',
  'scores.excellent': 'Çok iyi',
  'scores.good': 'İyi',
  'scores.moderate': 'Orta',
  'scores.low': 'Düşük',
  'scores.critical': 'Kritik',
  'maintenanceCategory.PLUMBING': 'Tesisat',
  'maintenanceCategory.ELECTRICAL': 'Elektrik',
  'maintenanceCategory.HEATING_COOLING': 'Isıtma/Soğutma',
  'maintenanceCategory.APPLIANCE': 'Cihazlar',
  'maintenanceCategory.STRUCTURAL': 'Yapısal',
  'maintenanceCategory.PEST_CONTROL': 'Haşere',
  'maintenanceCategory.SECURITY': 'Güvenlik',
  'maintenanceCategory.CLEANING': 'Temizlik',
  'maintenanceCategory.EXTERIOR': 'Dış alan',
  'maintenanceCategory.OTHER': 'Diğer',
  'activities.dashboardTitle': "Zürih'te etkinlikler",
  'activities.dashboardSubtitle': 'Ücretsiz ve uygun fiyatlı fırsatlar',
  'activities.noResults': 'Bu kategoride etkinlik bulunamadı.',
  'activities.dashboardCta': 'Tüm fırsatları göster',
  'activities.costFree': 'Ücretsiz',
  'activities.costReduced': 'İndirimli',
  'activities.costPaid': 'Ücretli',
  'satisfaction.title': 'Evinde nasılsın?',
  ...
  'satisfaction.thankYouTitle': 'Geri bildirimin için teşekkürler!',
  'satisfaction.thankYouMessage': 'Geri bildirimin evi iyileştirmemize yardımcı oluyor',
  'satisfaction.concernsForwarded': 'Endişelerini ilettik',
  'satisfaction.newFeedback': 'Yeni geri bildirim',
  'satisfaction.lastFeedback': 'Son geri bildirim',
  'satisfaction.today': 'Bugün',
  'satisfaction.dayAgo': '1 gün önce',
  'satisfaction.daysAgo': '{#} gün önce',
  'satisfaction.saveFailed': 'Kaydetme başarısız oldu. Lütfen tekrar dene.',
  'satisfaction.ratingBad': 'Kötü',
  'satisfaction.ratingOkay': 'İdare eder',
  'satisfaction.ratingGreat': 'Harika',
  'satisfaction.commentPrompt': 'Daha fazlasını anlatmak ister misin?',
  'satisfaction.optional': '(isteğe bağlı)',
  'satisfaction.commentPlaceholder': 'Neyi iyileştirebiliriz? Seni ne meşgul ediyor?',
  'satisfaction.submitting': 'Gönderiliyor...',
  'satisfaction.submit': 'Gönder',
  'satisfaction.submitWithoutComment': 'Yorum olmadan gönder',
  'satisfaction.submitFeedback': 'Geri bildirimi gönder',
  'satisfaction.ratingVeryDissatisfied': 'Çok memnun değilim',
  'satisfaction.ratingDissatisfied': 'Memnun değilim',
  'satisfaction.ratingNeutral': 'Nötr',
  'satisfaction.ratingSatisfied': 'Memnunum',
  'satisfaction.ratingVerySatisfied': 'Çok memnunum',
  'expenses.dashboardTitle': 'Giderler',
  'expenses.dashboardCta': 'Tüm giderleri göster',
  'expenses.dashboardBalance': 'Bakiyen',
  'expenses.balanceSettled': 'eşitlendi',
